...
def process_files(predictions_path, test_socratic_path, output_base_dir, index):
    ...
    # plt.show()
    plt.grid(True)
    plot_path = os.path.join(output_base_dir, f"output_{index}_finalCOT.png")
...
output_base_dir = "/Users/piyushigoyal/Documents/ETH Zürich/Mrinmaya's lab/Shridhar/GSM8K/test/outputs_finalCOT/"
